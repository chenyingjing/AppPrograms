...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"RADIO_LIST_CELL" forIndexPath:indexPath];
    ...
    logoImageView.image = [UIImage imageNamed:self.radioImages[indexPath.row]];
