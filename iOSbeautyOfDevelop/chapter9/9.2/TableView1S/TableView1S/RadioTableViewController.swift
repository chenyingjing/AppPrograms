...
class RadioTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("RADIO_LIST_CELL", forIndexPath: indexPath) as! UITableViewCell
...
//        cell.imageView?.image = UIImage(named: self.radioImages?[indexPath.row] as! String)
        ...
        var logoImageView = cell.viewWithTag(200) as! UIImageView
        logoImageView.image = UIImage(named: self.radioImages?[indexPath.row] as! String)
        
        var mainTitleLabel = cell.viewWithTag(201) as! UILabel
        mainTitleLabel.text = self.radioListArray?[indexPath.row] as? String
        
        var subTitleLabel = cell.viewWithTag(202) as! UILabel
        subTitleLabel.text = self.radioEnglishArray[indexPath.row]
