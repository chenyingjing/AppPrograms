    ...
    override public func willMoveToSuperview(newSuperview: UIView!) {
        if (nil != newSuperview) {
            ...
            dispatch_once(&TokenHolder.token) {
                let originMethod: Method = class_getInstanceMethod(object_getClass(self), Selector("drawPlaceholderInRect:"))
                let swizzledMethod: Method = class_getInstanceMethod(object_getClass(self), Selector("_drawPlaceholderInRect:"))
